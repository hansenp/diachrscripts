...
#PREFIX <- "../results_2/chesi/hepg2/chesi_hepg2_r3"
#PREFIX <- "../results_2/chesi/hepg2/chesi_hepg2_alt"
...
#PREFIX <- "../results_2/nora/treated/nora_treated_alt"

#PREFIX <- "../results_2/nora/washoff/nora_washoff_r1"
#PREFIX <- "../results_2/nora/washoff/nora_washoff_r2"
#PREFIX <- "../results_2/nora/washoff/nora_washoff_alt"
