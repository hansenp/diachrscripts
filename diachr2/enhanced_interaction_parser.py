...
class EnhancedInteractionParser:
    ...
    def _split_chromosomes(self, chrompair:str) -> Tuple:
        ...
        chromB, startB, endB = self._split_chromosome(pair[0])
    ...
    def parse(self) -> List:
        ...
        with gzip.open(self.path, 'rt') as fp:
            ...
            for line in fp:
                ...
                enh_int = EnhancedInteraction(chrA=chr_a, staA=sta_a, endA=end_a, symsA=syms_a,tssA=tsss_a,
                                              chrB=chr_b, staB=sta_b, endB=end_b, symsB=syms_b, tssB=tsss_b,
