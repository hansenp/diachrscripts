...
legend("topright", legend=c(LEGEND_1, LEGEND_2, LEGEND_3, LEGEND_4, LEGEND_5, LEGEND_6, LEGEND_7),
       col=c("black", "black", "black", "black", "black", "black", "black"), pch=c(20,20,20,20,20,20,20), cex=0.8)
