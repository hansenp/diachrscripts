...
do
  ...
  SRR_TRUNC_2=$(echo $SRR | rev | cut -c1-1)
  # Forward
  wget ftp://ftp.sra.ebi.ac.uk/vol1/fastq/$SRR_TRUNC/00$SRR_TRUNC_2/$SRR/$SRR\_1.fastq.gz -O $OUT_DIR/$SRR\_1.fastq.gz
  ...
  # Reverse
  wget ftp://ftp.sra.ebi.ac.uk/vol1/fastq/$SRR_TRUNC/00$SRR_TRUNC_2/$SRR/$SRR\_2.fastq.gz -O $OUT_DIR/$SRR\_2.fastq.gz
