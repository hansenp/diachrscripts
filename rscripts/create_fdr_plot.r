...
print(f_name)
cairo_pdf(f_name, width=5.3, height=4.7)
...
par(new=T)
plot(m_alt_pc, m_alt_fdr, col=PROTOCOL_COLOR, pch=3, xlim=c(0,XMAX), ylim=c(0,YMAX), xlab="P-value threshold", ylab="Estimated FDR")
abline(h=0.25, lty=2)
par(new=T)
